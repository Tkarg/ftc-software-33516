...
*
* We are using a pair of REV 41 motors because we are out of resources.
*
...
@Autonomous(name = "A_BLUE_N")
public class _AutonomousBlueNear_ extends LinearOpMode{
    ...
    public static class ArtefactHandler{
        ...
        /*
        * Turns out the ideal launch speed for AUTO is going to be 2500RPM at point (-24;-24) for blue.
        * */
    ...
    public void runOpMode() throws InterruptedException{
        Pose2d Location = new Pose2d(-51, -54, Math.toRadians(51));
        ...
        Action Path1 = Base.actionBuilder(Location)
                ...
                .build();
        Action Path2 = Base.actionBuilder(new Pose2d(-24, -24, Math.toRadians(220)))
                .strafeToSplineHeading(new Vector2d(-12, -20), Math.toRadians(270))
                .build();
        Action Path3 = Base.actionBuilder(new Pose2d(-12, -20, Math.toRadians(270)))
                .strafeTo(new Vector2d(-12, -52))
                .build();
        Action Path4 = Base.actionBuilder(new Pose2d(-12, -52, Math.toRadians(270)))
        ...
        Action Path5 = Base.actionBuilder(new Pose2d(-24, -24, Math.toRadians(225)))
                .strafeToSplineHeading(new Vector2d(12, -20), Math.toRadians(270))
                .build();
        //Why can't lateral just be lateral?
        ...
        Action Path8 = Base.actionBuilder(new Pose2d(-24, -24, Math.toRadians(225)))
                ...
                .build();
        //Splines ruin my paths!
        Action Path9 = Base.actionBuilder(new Pose2d(36, -30, Math.toRadians(270)))
