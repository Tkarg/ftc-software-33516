...
@Autonomous(name = "A_RED_F")
public class _AutonomousRedFar_ extends LinearOpMode{
    ...
    public static class ArtefactHandler{
        ...
        /*
         * Turns out the ideal launch speed for AUTO is going to be 3350RPM at point (+60;+12) for red.
         * */
         ...
         * For F it is fine at 3100, since we had had enough tuning for the day (and because it works).
